...
{% swagger-response status="201: Created" description="북마크 생성 성공" %}
...
{% swagger-response status="404: Not Found" description="존재하지 않는 게시글에 북마크 생성 요청" %}
```json
{
...
{% swagger-response status="200: OK" description="북마크 제거 성공" %}
{% code lineNumbers="true" %}
```json
{
...
{% swagger-response status="404: Not Found" description="존재하지 않는 게시글에 북마크 제거 요청" %}
```json
{
    "message": "존재하지 않는 게시글입니다."
}
